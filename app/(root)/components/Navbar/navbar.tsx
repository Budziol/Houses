...
import NavMenu from "@/app/(root)/components/Navbar/nav-menu";
import MobileNavMenu from "@/app/(root)/components/Navbar/mobile-mav-menu";
    ...
    >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <MobileNavMenu close={() => setIsOpen(false)} />
          </motion.div>
        )}
      </AnimatePresence>
    </motion.header>
